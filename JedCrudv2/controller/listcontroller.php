...
while($row = mysql_fetch_array($result))
    ...
    echo "<tr>";
        ...
        echo "<td valign='top'>" . ( $row['contact']) . "</td>";?>
              <td valign='top'>
                <a href="view/edit.php?id=<?php echo $row['id']; ?>">Edit</a>
              </td>
              <td>
                <a href="controller/deletecontroller.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure want to Update?'); "</a>Delete
              </td>
         </tr>
<?php }?>
</form>
